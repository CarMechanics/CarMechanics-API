...
namespace ProiectColectiv.Migrations
{
    ...
    [Migration("20240116174658_FreshStart")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProiectColectiv.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ProiectColectiv.Data.AutoPartShop", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProiectColectiv.Data.Service", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ProiectColectiv.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProiectColectiv.Data.AutoPartShop", b =>
                {
                    b.HasOne("ProiectColectiv.Data.AutoPart", "AutoPart")
                        .WithMany("AutoPartShops")
                        .HasForeignKey("AutoPartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProiectColectiv.Data.Shop", "Shop")
                        .WithMany("AutoPartShop")
            ...
            modelBuilder.Entity("ProiectColectiv.Data.Review", b =>
                {
                    ...
                    b.HasOne("ProiectColectiv.Data.Service", null)
                        .WithMany("Reviews")
