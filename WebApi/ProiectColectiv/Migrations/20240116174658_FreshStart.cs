        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BrandInfoId = table.Column<int>(type: "int", nullable: false),
                    UserName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NormalizedUserName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NormalizedEmail = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Credential_CredentialId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AutoPartShop", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AutoPartShop_AutoParts_AutoPartId",
                        column: x => x.AutoPartId,
                        principalTable: "AutoParts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AutoPartShop_Shops_ShopId",
                        column: x => x.ShopId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Workers_Reviews_ReviewId",
                        column: x => x.ReviewId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_CredentialId",
                table: "AspNetUsers",
                column: "CredentialId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AutoPartShop_AutoPartId",
                table: "AutoPartShop",
                column: "AutoPartId");

            migrationBuilder.CreateIndex(
                name: "IX_AutoPartShop_ShopId",
                table: "AutoPartShop",
                column: "ShopId");
